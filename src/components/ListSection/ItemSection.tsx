      ...
      {title !== "line" ? (
        ...
        >
          ...
          >
            ...
            {isActive && (
              <div className="absolute inset-0 rounded-xl bg-omnia-blue/10 blur-md" />
            )}
          ...
          <p 
            className={`text-xs mt-1.5 font-medium transition-colors duration-200 ${
              isActive 
                ? "text-omnia-blue" 
                : "text-omnia-navy/50 group-hover:text-omnia-navy/80"
            }`}
          >
            {t(translationKey)}
          </p>
        ...
        <div className="mx-auto my-3 w-10 h-px bg-omnia-navy/10" />
      )}
    </li>
  );
};
