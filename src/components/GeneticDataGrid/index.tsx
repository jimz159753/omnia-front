...
import { DataGridPro, GridValidRowModel, GridColDef, GridRowId, GridCallbackDetails } from '@mui/x-data-grid-pro';
...
interface IGeneticDataGridProps<T> {
  ...
  sx?: object;
  getDetailPanelContent?: (params: {row: IBooking, id: GridRowId, column?: GridColDef} ) => React.ReactNode;
...
const GeneticDataGrid = <T,>({ data, columns, sx, getDetailPanelContent, onDetailPanelExpandedRowIdsChange, loading, detailPanelExpandedRowIds }: IGeneticDataGridProps<T>) => {
  return (
    <DataGridPro
      loading={loading}
      sx={sx}
