  ...
  return (
    <div className="w-32 bg-white shadow-lg h-screen sticky top-0 flex flex-col items-center gap-4 pt-16">
      <button
        ...
        className="bg-brand-500 text-white px-4 py-4 rounded-md font-bold text-2xl w-12 h-12 flex items-center justify-center hover:bg-brand-600 transition-colors"
      >
